...
<body>
  ...
  <div class="section">
    <div class="container">
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/valores1.jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES1.jpg">
        </div>
        <div class="blog-info">
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/valores2.jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES1.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            INOVACIÓN.
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/valores3.jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES3.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            SALUD.
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/valores4.jpg" alt="Imagenes de pixabayderechos reservados de la pagina valores4.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            APOYO MUTUO.
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/valores5.jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES1.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            TALENTO CREACTIVO.
      ...
      <div class="blog2 row-revere">
        <div class="blog-img">
          <img src="./public/images/cuidados-pies-sanos-bonitos_d1b3a791_1200x1200.jpg" alt="Imagenes de pixabayderechos reservados de la pagina ARTICULO_NUTRICION_DEPORTE.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            MISIÓN.
      ...
      <div class="blog2 row-revere">
        <div class="blog-img">
          <img src="./public/images/Fascitis-plantar-grafico.png" alt="">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            VISIÓN.
