...
<body>
  ...
  <div class="section">
    <div class="container">
      ...
      <div class="container5">
        ...
        <img src="./public/images/persona_preguntando-removebg-preview.png" alt="logotipo de cuestions">
      </div>
      ...
      <div class="blog2 row-revere">
        <div class="blog-img">
          <img src="./public/images/apoyos y becas .jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES1.jpg">
        </div>
        <div class="blog-info">
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/Laboratorio-01-scaled.jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES1.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
      ...
      <div class="blog2 row-revere">
        <div class="blog-img">
          <img src="./public/images/Financiamento-para-empresas.jpg" alt="Imagenes de pixabayderechos reservados de la pagina VALORES3.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
      ...
      <div class="blog2">
        <div class="blog-img">
          <img src="./public/images/71aGA7f5n+L.jpg" alt="Imagenes de pixabayderechos reservados de la pagina valores4.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
      ...
      <div class="blog2 row-revere">
        <div class="blog-img">
          <img src="./public/images/PodologiaDx-100x100.png" alt="Imagenes de pixabayderechos reservados de la pagina VALORES1.jpg">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            CONOCENOS
  ...
  <div class="section">
    <div class="container">
      ...
      <div class="blog">
        <div class="blog-img">
          <img src="./public/images/masaje-pies-bebe.jpg" alt="Imagenes de Pixabay Todos los Derechos Reservados.Pies de bebe manos">
        </div>
        <div class="blog-info">
          <div class="blog-title">
            CUIDA TUS PIES
